...
if os.path.isfile(WORD_TO_INT):
    with open(WORD_TO_INT, 'rb') as f:
    ...
    with open(WORD_TO_INT, 'wb+') as f1:
        pickle.dump(word_to_int, f1, pickle.HIGHEST_PROTOCOL)

    with open(INT_TO_WORD, 'wb+') as f2:
        pickle.dump(int_to_word, f2, pickle.HIGHEST_PROTOCOL)
